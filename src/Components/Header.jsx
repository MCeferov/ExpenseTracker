    ...
    <header className="flex justify-between items-start">
      <div className="flex">
        ...
        <div>
          ...
          <h1 className="text-lg font-bold text-slate-800">Elbnax</h1>
        </div>
      </div>
      <button onClick={toggleLayout} className="h-8 w-8 bg-gradient-to-r bg-pink from-pink to-lightblue flex items-center justify-center text-white rounded-full ">
